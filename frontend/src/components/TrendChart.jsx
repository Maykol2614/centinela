...
export default function TrendChart({ titulo, datos, dataKey, color, umbral, umbralEtiqueta, max = 1023 }) {
      ...
      <div className="h-56">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={puntos} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
            ...
            <YAxis stroke="#A79C82" fontSize={11} tickLine={false} domain={[0, max]} />
            <Tooltip
