...
def obtener_estadisticas(db: Session = Depends(get_db)):
    # Se agrupa por el día calendario en hora de Lima (no UTC), para que una
    # lectura tomada a las 20:00 en Lima no se cuente como "el día siguiente".
    dia = cast(func.timezone("America/Lima", models.Lectura.creado_en), Date)
